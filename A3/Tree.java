...
public interface Tree<E> {
     ...
     * than one were present, removes only the first one)
     *
    ...
    /**
     * Returns the height of the tree. For an empty tree should return -1. For a
     * tree of one node should return 0
     *
